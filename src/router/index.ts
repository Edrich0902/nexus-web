  ...
  },
  {
    ...
    meta: handleMeta(true, true, 'F1 Session'),
      ...
      },
      {
        path: '/cellar',
        name: 'cellar',
        component: () => import('@routes/cellar/CellarView.vue'),
        meta: handleMeta(true, true, 'Wine'),
      },
      {
        path: '/cellar/wines/:wineId',
        name: 'cellar-wine',
        component: () => import('@routes/cellar/CellarWineView.vue'),
        meta: handleMeta(true, true, 'Wine detail'),
      },
      {
        path: '/kitchen',
        name: 'kitchen',
        component: () => import('@routes/kitchen/KitchenView.vue'),
        meta: handleMeta(true, true, 'Recipes'),
      },
      {
        path: '/kitchen/discover',
        name: 'kitchen-discover',
        component: () => import('@routes/kitchen/KitchenDiscoverView.vue'),
        meta: handleMeta(true, true, 'Discover recipes'),
      },
      {
        path: '/kitchen/discover/:mealdbId',
        name: 'kitchen-meal-preview',
        component: () => import('@routes/kitchen/KitchenMealPreviewView.vue'),
        meta: handleMeta(true, true, 'Recipe preview'),
      },
      {
        path: '/kitchen/recipes/:recipeId',
        name: 'kitchen-recipe',
        component: () => import('@routes/kitchen/KitchenRecipeView.vue'),
        meta: handleMeta(true, true, 'Recipe'),
      },
      {
        path: '/beer',
        name: 'beer',
        component: () => import('@routes/beer/BeerView.vue'),
        meta: handleMeta(true, true, 'Beer'),
      },
      {
        path: '/beer/beers/:beerId',
        name: 'beer-detail',
        component: () => import('@routes/beer/BeerDetailView.vue'),
        meta: handleMeta(true, true, 'Beer detail'),
      },
      {
        path: '/beer/breweries/:breweryId',
        name: 'beer-brewery',
        component: () => import('@routes/beer/BeerBreweryView.vue'),
      ...
      },
      {
        ...
        meta: handleMeta(true, true, 'Food & Drink'),
      },
      {
        path: '/food-drink/pairings',
        name: 'food-drink-pairings',
        component: () => import('@routes/food-drink/FoodDrinkPairingsView.vue'),
        meta: handleMeta(true, true, 'Pairings'),
      },
      {
        path: '/admin',
        name: 'admin',
